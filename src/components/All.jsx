...
import 'bootstrap/dist/css/bootstrap.min.css'; // Only this import needed for styling
import 'bootstrap/dist/js/bootstrap.bundle.min.js'; // This import is for JavaScript functionality
// ✅ Correct (because both files are in the same folder)



import About from './About';
import image from '../assets/Logo1.jpg'; // already correct
...
import img4 from '../assets/slide4.avif';
  ...
  return (
    <div className="home-page">
      ...
      <Carousel
        controls={true}
        indicators={true}
        interval={5000}  // Auto slide change every 5 seconds
        ride="carousel"  // Enable auto sliding on load
        pause="false"   // Disable pause on hover, it will continue sliding even when hovered
      >
        <Carousel.Item>
